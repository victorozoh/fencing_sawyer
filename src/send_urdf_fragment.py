...
def main():
    ...
    sword_parent_link = "right_hand"
    sword_root_joint = "right_gripper_base"
    sword_duration = 5.0
    sword_file = "/home/victor/sawyerws/src/fencing_sawyer/urdf/sword.urdf"

    rospy.init_node('modify_urdf', anonymous=True)

    if not os.access(sword_file, os.R_OK):
        rospy.logerr("Cannot read file at '%s'" % (sword_file,))
        return 1
    send_urdf(sword_parent_link, sword_root_joint, sword_file, sword_duration)
    return 0
